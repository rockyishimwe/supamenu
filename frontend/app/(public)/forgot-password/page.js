...
import { Mail, ShieldCheck, ChevronLeft, ArrowRight, UtensilsCrossed } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-[#0f1115] border border-white/5 rounded-3xl p-8 sm:p-10 shadow-2xl relative">
        ...
        {sent ? (
          <div className="text-center space-y-6 relative z-10">
            ...
            <Link 
              href="/login" 
              className="inline-flex items-center gap-2 text-xs font-semibold text-[#FF6B00] hover:underline pt-4"
            >
