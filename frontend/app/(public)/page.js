...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-surface text-body">
      ...
      {/* Featured Restaurants with 3D Tilt Effect */}
      ...
      >
        ...
        >
          {/* Restaurant data would ideally come from an API or CMS - using mock data for demo */}
          {[
            {
              id: 1,
            ...
            },
            {
              ...
              tags: ["Authentic", "Omakase", "Fresh Fish"]
            },
            {
              id: 3,
              name: "Spice Route",
              ...
              tags: ["Spicy", "Vegetarian Friendly", "Street Food"]
            },
            {
              id: 4,
              name: "La Taquería",
            ...
            },
            {
              ...
              tags: ["Plant-Based", "Gluten-Free", "Superfoods"]
            },
            {
              id: 6,
              name: "Blue Marlin",
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {restaurant.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-2 py-0.5 text-xs font-medium rounded-full bg-white/10 border border-white/5"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <Link
                      ...
                      className="mt-4 inline-flex items-center gap-2 text-xs font-semibold text-[#FF6B00] hover:text-white transition-colors"
                    >
                      Explore Menu
