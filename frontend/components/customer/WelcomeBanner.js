...
import { fadeUpItem, slideInLeft, slideInRight } from '../PageTransition';
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="md:col-span-8 bg-gradient-to-br from-[#0f1115] to-[#07090e] border border-white/5 p-6 rounded-3xl relative overflow-hidden flex flex-col justify-between card-shine"
      >
        {/* Decorative glow */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#FF6B00]/5 rounded-full filter blur-3xl orb-float-1" />
        <div className="absolute top-0 left-0 w-48 h-48 bg-blue-500/4 rounded-full filter blur-3xl orb-float-2" />
        ...
        <motion.div
          ...
          className="flex flex-wrap gap-6 pt-6 border-t border-white/5 mt-6 items-center"
        >
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="md:col-span-4 bg-panel border border-white/5 p-6 rounded-3xl flex flex-col justify-between relative overflow-hidden card-shine"
      >
        ...
        <motion.div
          ...
          className="pt-4"
        >
          <Link href="/customer/profile?tab=wallet" className="w-full py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-center text-xs text-white font-semibold transition-all duration-200 block hover-lift">
            Top Up Wallet
          </Link>
        </motion.div>
      </motion.div>
